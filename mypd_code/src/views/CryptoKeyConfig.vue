<template>
    <div>
        ...
        <van-form @submit="onSubmit">
            <van-field autocomplete="off" ref="cryptoKeyConfigField" v-model="password" type="password" name="密码" label="密码" placeholder="加密key,必须牢记" :rules="[{ required: true, message: '请填写密码' }]" />
